...
parser = argparse.ArgumentParser(description="Convert from audio files to segment files using MAE ViT model with 16kHz linear spectrograms and data division YAML support.")
