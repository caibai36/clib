...
default_model = "exp/sys/timit/division_timit_winmid0.05size0.5shift0.05_noisekeep1/cnn-run0/bs2048lr0.0003lrdecay1avgpredwin5/train/model.ckpt"
...
parser = argparse.ArgumentParser(description="Convert from audio files to segment files using riken CNN model with data division YAML support.")
