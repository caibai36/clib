...
eval_model="exp/sys_mae_vit/timit/division_timit_winmid0.05size0.5shift0.05_noisekeep1/mae_vit-run0/bs256baselr0.0001wd0.3warmup5total25avgpredwin5_dim768depth12heads12mlpdim3072patch16dropout0.1maetrain6maepretrainedbase/train/model.ckpt"  # Path to the model checkpoint
result_dir="exp/sandbox/eval/mae_vit"  # Directory to store evaluation results
...
predict_script="local/sandbox/riken_mae_vit_audio2seg_highres_padding.py"
