...
parser = argparse.ArgumentParser(description="Convert from audio files to segment files using riken CNN model with 16kHz mel spectrograms and data division YAML support.")
