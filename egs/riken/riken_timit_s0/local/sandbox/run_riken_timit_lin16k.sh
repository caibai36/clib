...
if [ ${stage} -le 2 ]; then
    ...
    python local/riken_cnn_data_prep_torchaudio_lin16k.py \
	   --info_json $info_json \
...
# # use local/sandbox/riken_cnn_audio2seg_highres.py
...
# if [ ${stage} -le 4 ]; then
#     date
#     echo "Test riken cnn with linear spectrograms (FFT=512)..."
