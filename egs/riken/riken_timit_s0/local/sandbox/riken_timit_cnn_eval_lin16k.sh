...
# Updated to use linear spectrograms (FFT=512) model
eval_model="exp/sys/timit/division_timit_winmid0.05size0.5shift0.05_noisekeep1_lin16k/cnn-run0/bs2048lr0.0003lrdecay1avgpredwin5/train/model.ckpt"  # Path to the model checkpoint
result_dir="exp/sandbox/eval/cnn_lin16k"  # Directory to store evaluation results
...
# Path to prediction script - Updated to use linear spectrograms version
predict_script="local/sandbox/riken_cnn_audio2seg_highres_padding_lin16k.py"
