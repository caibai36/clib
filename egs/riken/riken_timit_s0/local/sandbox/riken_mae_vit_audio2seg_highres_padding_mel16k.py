...
if args.fast_pred:
    merged_seg_file = args.out_seg_file or os.path.join(out_dir, f"mae_vit_pred_{file_name}_mel16k.txt") # When out_file not specified, use out_dir
else:
    merged_seg_file = args.out_seg_file or os.path.join(out_dir, f"mae_vit_pred_resol{args.pred_resolution}_{file_name}_mel16k.txt") # When out_file not specified, use out_dir
