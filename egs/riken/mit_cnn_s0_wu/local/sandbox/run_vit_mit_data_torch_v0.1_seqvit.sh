...
if [ ${stage} -le 2 ]; then
    ...
    python local/mit_vit_train_72_torch_v0.1.py --train_input1 exp/data/$dataset_name/train_input1 \
       --seq \
...
if [ ${stage} -le 3 ]; then
    ...
    python local/mit_vit_test_72_torch_v0.1.py --test_input1 exp/data/$dataset_name/test_input1_$first \
	--seq \
