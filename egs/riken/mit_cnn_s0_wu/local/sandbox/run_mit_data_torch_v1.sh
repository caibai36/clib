...
if [ ${stage} -le 2 ]; then
    ...
    python local/mit_cnn_train_72_torch_v1.py --train_input1 exp/data/$dataset_name/train_input1 \
...
if [ ${stage} -le 3 ]; then
    ...
    python local/mit_cnn_test_72_torch_v1.py --test_input1 exp/data/$dataset_name/test_input1_$first \
