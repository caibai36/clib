...
#    -> v5: use pretrained MAE ViT (not with warmup scheduler)
...
# MAE ViT specific arguments
parser.add_argument("--image_size", type=int, default=224, help="Size of input image")  # Changed from 256 to 224
parser.add_argument("--patch_size", type=int, default=16, help="Size of patch")
parser.add_argument("--num_classes", type=int, default=9, help="Number of classes")
parser.add_argument("--dim", type=int, default=768, help="Dimension of ViT")  # Changed from 384 to 768
parser.add_argument("--depth", type=int, default=12, help="Depth of ViT")
parser.add_argument("--heads", type=int, default=12, help="Number of attention heads")  # Changed from 6 to 12
parser.add_argument("--mlp_dim", type=int, default=3072, help="Dimension of MLP layer")
parser.add_argument("--pool", type=str, default='cls', help="Pooling type (cls or mean)")
parser.add_argument("--channels", type=int, default=1, help="Number of input channels")
parser.add_argument("--dim_head", type=int, default=64, help="Dimension of each attention head")
...
if __name__ == '__main__':
    ...
    # Initialize logger
    logger = init_logger(os.path.join(os.path.dirname(model_path), "report.log"))
    logger.info(args)
    ...
    if args.model_type == "vit":
        ...
        logger.info("Initialized ViT model")
    else:  # model_type == "mae"
        mae_params = {
            'image_size': args.image_size,
            'patch_size': patch_size,
