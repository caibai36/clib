...
model_name=mae_vit  # Changed from cnn to vit
exp_dir=exp/sys_mae_vit  # Changed from sys_vit to sys_mae_vit
...
mae_pretrained="exp/mae_pretraining/nas5_b2_mae_pretrained_48days/base/model_epoch_400_base_48days.pt"       # "base" for facebook/vit-mae-base, path to pretrained model, or empty string for no pretraining
