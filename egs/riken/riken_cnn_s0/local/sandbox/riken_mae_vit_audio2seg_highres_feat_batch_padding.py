...
default_model = "conf/model/RIKEN2024pretrained_b0family3010_mae_base_48days_best_dev.ckpt"
default_wav_file = "/home/bin-wu/share/data/riken/sample/1100F_0124_2017_0s_10s_ch1.wav"
default_dict = "conf/dict/label2id.yaml"
default_resolution=0.05 # 0.01
...
parser.add_argument("--feat_batch_size", type=int, default=20480, help="Feat batch size for the extracting features (make it 25 if GPU memory small, 20480 if large")
...
parser.add_argument("--fixed_factor", type=float, default=0.1,
