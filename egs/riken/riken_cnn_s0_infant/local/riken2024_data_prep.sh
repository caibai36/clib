...
# Data
riken2024=/data/share/bin-wu/data/marmoset/vocalization/riken2024
...
if [ ${stage} -le 1 ]; then
    ...
    rm -rf data/$data_name/wav.scp data/$data_name/seg.scp data/$data_name/seg2d.scp data/$data_name/subset.scp

    # Wav files
    for file in "$riken2024"/*/seg/*.txt; do
    ...
    python local/scripts/data2info.py \
        --data data/$data_name \
        --scps seg:data/$data_name/seg.scp seg2d:data/$data_name/seg2d.scp subset:data/$data_name/subset.scp\
