...
data_dir_name=riken2024_nakanishi_wara
model_name=cnn
exp_dir=exp/sys

# Options for data
data_div_yaml="conf/data/division_nakanishi_wara.yaml"  # YAML file containing data division by IDs for train, dev, and test sets
