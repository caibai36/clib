...
parser.add_argument("--window_shift", type=float, default=0.05, help="The shift of the sliding window in seconds for label assignment (default: 0.05).")
parser.add_argument("--middle_part", type=float, default=0.05, help="The proportion of the middle part of the window in seconds for label assignment (default: 0.05).")
...
noise_correct, signal_correct = compare_segments(prediction_list, correct_list, classes, window_size=args.window_size, window_shift=args.window_shift, middle_part=args.middle_part)
evaluate_metrics(signal_correct, noise_correct)

# Compute the confusion matrix and save it to png and yaml files
confusion_matrix, labels = compute_confusion_matrix(prediction_list, correct_list, label2id, window_size=args.window_size, window_shift=args.window_shift, middle_part=args.middle_part)
