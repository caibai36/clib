...
run=run0
dataset_name=infant_miki
data_dir_name=infant_miki_examples
model_name=cnn
exp_dir=exp/sys

# Options for data
data_div_yaml="conf/data/division_infant_miki_examples.yaml"  # YAML file containing data division by IDs for train, dev, and test sets
label2id_yaml="conf/dict/label2id_infant_miki_examples.yaml"  # YAML file containing label-to-labelID mapping
...
noise_preserve_steps=1 # 5  # Number of steps to skip between preserved all-noise-no-label chunks # 1 means keeping all noise segments

test_id=HR01_008_4_Label # One test id in $data_div_yaml file
...
info_json="data/infant_miki_examples/info.json"  # JSON file mapping IDs to audio and label file paths
