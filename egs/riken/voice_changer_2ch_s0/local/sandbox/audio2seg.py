...
# truth_values=['cha','chi','ek','ph','ts','tr','trph','tw','noise']
truth_values=['cr','cp','ek','ph','ts','tr','pp','tw','noise']
...
default_model="exp/run/riken_vc/riken_vc0/mit_cnn_72-run0/bs25lr0.0003evalinterval1avgpredwin5/train/model.ckpt"
default_wav1="/data01/share/bin-wu/data/marmoset/vocalization/voice_changer_2ch/pair1/pair1_animal1_240711-0985.wav"
default_wav2="/data01/share/bin-wu/data/marmoset/vocalization/voice_changer_2ch/pair1/pair1_animal2_240711-0985.wav"
...
if __name__ == '__main__':
    ...
    parser.add_argument("--wav_file1", type=str, default=default_wav1, help="Path of first input wav")
    parser.add_argument("--wav_file2", type=str, default=default_wav2, help="Path of second input wav (optional); use "" when not needed")
