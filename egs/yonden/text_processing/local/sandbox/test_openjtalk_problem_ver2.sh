...
python local/scripts/normalize_openjtalk_with_mecab_chouon_local.py --openjtalk_text exp/output/text.openjtalk --mecab_text exp/output/text.mecab --has_uttid --verbose
