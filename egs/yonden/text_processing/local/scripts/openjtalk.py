...
parser.add_argument("--pos", action="store_true", help="add fields of part of speech of '表層形|読み|品詞|品詞細分類1' (e.g., 柱|ハシラ|名詞|一般 上|ジョー|名詞|接尾 or 瑤泉院|ヨーゼーイン|名詞|固有名詞)")
parser.add_argument("--full", action="store_true", help="print all fields of '表層形|読み|品詞|品詞細分類1|品詞細分類2|品詞細分類3|活用型|活用形' (e.g., 柱|ハシラ|名詞|一般|*|*|*|* 上|ジョー|名詞|接尾|副詞可能|*|*|* or 瑤泉院|ヨーゼーイン|名詞|固有名詞|人名|一般|*|* or ああなり|アーナリ|動詞|自立|*|*|五段・ラ行|連用形)")
