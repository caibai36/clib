...
feat_train=$PWD/data/train_data3_5_7to17_baseline/feats.scp
feat_dev=$PWD/data/dev_data4_baseline/feats.scp
feat_test=$PWD/data/test_data6_baseline/feats.scp

./local/sandbox/asr_general/run_all_full.sh --run_kana_asr true --tag ${tag} --feat_name ${feat_name} \
