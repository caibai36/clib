...
train_data=/project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/wsj/s0/data/train_si84_first1000
...
dpgmm_data_dir=exp/dpgmm2asr/asr_${dname}_${tag}_dpgmm_seed${seed}_K${K0}_from_${feat_name}/data

feat_train2=$dpgmm_data_dir/train/feats.scp
feat_dev2=$dpgmm_data_dir/dev/feats.scp
feat_test2=$dpgmm_data_dir/test/feats.scp

root=exp/concatfeat2asr/asr_${dname}_${tag}_${feat_name}_dpgmm_embedding_seed${seed}_K${K0}
feat=concat_${dname}_${tag}_${feat_name}_dpgmm_embedding_seed${seed}_K${K0}
