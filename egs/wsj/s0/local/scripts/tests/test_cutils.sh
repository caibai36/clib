...
cat cutils/tests/data/dump/token.scp | cutils/scp2json.py -k token | tee cutils/tests/data/dump/token.json

cat cutils/tests/data/dump/text.scp | cutils/scp2json.py -k text | tee cutils/tests/data/dump/text.json
cat cutils/tests/data/dump/tokenid.scp | cutils/scp2json.py -k tokenid | tee cutils/tests/data/dump/tokenid.json

# mergejson.py cutils/tests/data/dump/*json --output-json cutils/tests/data/data.json
cutils/mergejson.py cutils/tests/data/dump/*json --output-utts-json cutils/tests/data/utts.json --output-json cutils/tests/data/data.json
