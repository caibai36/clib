...
if [ $stage -le 0 ]; then
  ...
  #
  corpus=/project/nakamura-lab01/Share/Corpora/Speech/en/WSJ/
  ...
  for x in test_eval92 test_eval93 test_dev93 train_si284; do
    steps/make_mfcc.sh --mfcc-config $mfcc_config --cmd "$train_cmd" --nj 20 data/$x || exit 1;
...
########################################################################################
# # Codes for running neural network
...
# dir=data/train_si284
# utils/subset_data_dir_tr_cv.sh $dir ${dir}_tr90 ${dir}_cv10

# steps/nnet/train.sh --hid-layers 2 --hid-dim 256 --splice 5 --learn-rate 0.008 data/train_si284_tr90 data/train_si284_cv10 data/lang_nosp  exp/tri2b_ali_si284 exp/tri2b_ali_si284 exp/nnet   
