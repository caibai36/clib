...
dpgmm_train=exp/dpgmm2asr/asr_wsj0_si84_dpgmm_seed${seed}_K${K0}/data/train/feats.scp
dpgmm_dev=exp/dpgmm2asr/asr_wsj0_si84_dpgmm_seed${seed}_K${K0}/data/dev/feats.scp
dpgmm_test=exp/dpgmm2asr/asr_wsj0_si84_dpgmm_seed${seed}_K${K0}/data/test/feats.scp

root=exp/hybrid2asr_mse/asr_hybrid_mse_wsj0_si84_seed${seed}_K${K0}_l${num_left_context}r${num_right_context}
data_dir=$root/data
if [ $stage -le 1 ]; then
...
feat=hybrid_mse_wsj0_si84_seed${seed}_K${K0}_l${num_left_context}r${num_right_context}
if [ $stage -le 5 ]; then
    mkdir -p $root/conf
