...
mode=1 # different modes of text processing for data of tandem system; e.g. 3 for wsj
bnf_dim=42
...
# tag=si84_first${N}
tag=si284
dataset_name=wsj # timit # wsj
data_name=wsj1
feat_name=MFCC40

# train_data=$PWD/data/train_si84_first${N} # /project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/wsj/s0/data/train_si84
train_data=/project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/wsj/s0/data/train_si284
dev_data=$PWD/data/test_dev93 # /project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/wsj/s0/data/test_dev93
test_data=$PWD/data/test_eval92 # /project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/wsj/s0/data/test_eval92
train_set=train_si284 # name of the training data set
...
if $cat_hybrid_bnf_asr; then
    root1=exp/concatfeat2asr/asr_wsj1_concat_MFCC40_HybridMSE_wsj1_seed123nseed2022K98l8r8_bs256_hd512_nl5_ne20
    train1=$root1/data/train/feats.scp
    dev1=$root1/data/dev/feats.scp
    test1=$root1/data/test/feats.scp

    # root2=exp/bnf2asr/asr_${data_name}_${tag}_single_BNF${bnf_dim}
    ...
    ln -s /project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/wsj/bnf42/param_bnf param_bnf # a feature stored as param_bnf/raw_bnfeat_train_si284.1.ark
    train2=/project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/wsj/bnf42/data_bnf/train_bnf/feats.scp
    dev2=/project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/wsj/bnf42/data_bnf/dev93_bnf/feats.scp
    test2=/project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/wsj/bnf42/data_bnf/eval92_bnf/feats.scp
