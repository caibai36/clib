...
root=exp/dpgmm2asr/asr_${data_name}_${tag}_dpgmm_seed${seed}_K${K0}_from_${feat_name}
feat=${data_name}_${tag}_dpgmm_seed${seed}_K${K0}_from_${feat_name}
