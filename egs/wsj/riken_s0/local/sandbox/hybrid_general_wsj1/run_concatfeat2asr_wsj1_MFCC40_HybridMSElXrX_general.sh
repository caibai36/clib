...
feat1_name=MFCC40
feat2_name=HybridMSE_wsj1_seed${seed}nseed${nseed}K${K0}l${num_left_context}r${num_right_context}_bs${hybrid_batch_size}_hd${hybrid_hidden_dim}_nl${hybrid_num_layers}_ne${hybrid_num_epochs}
...
feat_train2=/project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/wsj/s0/exp/hybrid2asr_mse/asr_hybrid_mse_wsj1_si284_seed${seed}nseed${nseed}_K${K0}_l${num_left_context}r${num_right_context}_bs${hybrid_batch_size}_hd${hybrid_hidden_dim}_nl${hybrid_num_layers}_ne${hybrid_num_epochs}/data/train/feats.scp
feat_dev2=/project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/wsj/s0/exp/hybrid2asr_mse/asr_hybrid_mse_wsj1_si284_seed${seed}nseed${nseed}_K${K0}_l${num_left_context}r${num_right_context}_bs${hybrid_batch_size}_hd${hybrid_hidden_dim}_nl${hybrid_num_layers}_ne${hybrid_num_epochs}/data/dev/feats.scp
feat_test2=/project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/wsj/s0/exp/hybrid2asr_mse/asr_hybrid_mse_wsj1_si284_seed${seed}nseed${nseed}_K${K0}_l${num_left_context}r${num_right_context}_bs${hybrid_batch_size}_hd${hybrid_hidden_dim}_nl${hybrid_num_layers}_ne${hybrid_num_epochs}/data/test/feats.scp
