...
feat_train=data/train_si84/feats.scp
feat_dev=data/test_dev93/feats.scp
feat_test=data/test_eval92/feats.scp

root=exp/dpgmm2asr/asr_wsj0_si84_dpgmm_seed${seed}_K${K0}
data_dir=$root/data
if [ $stage -le 1 ]; then
    ...
    cp -r data/train_si84 $data_dir/train
...
if [ $stage -le 5 ]; then
    ...
    echo "token2id: '/project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/wsj/s0/data/lang_1char/train_si284_units.txt'" >> $root/conf/data_dpgmm_seed${seed}_K${K0}.yaml
fi
