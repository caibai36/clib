...
dname=wsj0 # train:si84;dev:dev93;test:eval92
feat_name=MFCC40
...
root=exp/dpgmm2asr/asr_${dname}_${tag}_dpgmm_seed${seed}_K${K0}_from_${feat_name}
feat=${dname}_${tag}_dpgmm_seed${seed}_K${K0}_from_${feat_name}
