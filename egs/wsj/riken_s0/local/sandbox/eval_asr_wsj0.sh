...
dataset_name=wsj
data_name=wsj0  # train:si284;dev:dev93;test:eval92
set_uttid=None # subset of testing data (e.g. set_uttid=conf/data/test_small/set_uttid.txt)

# model_path=exp/tmp/wsj/wsj0/EncRNNDecRNNAtt-enc3_bi256_ds3_drop-dec1_h512_do0.25-att_mlp-run0/mfcc40_batchsize32_cutoff1600_labelsmoothing0.05_lr0.001_gradclip5_factor0.5_patience3/train/model_e30.mdl
model_path=exp/tmp/wsj/wsj0/EncRNNDecRNNAtt-enc3_bi256_ds3_drop-dec1_h512_do0.25-att_mlp-run0/mfcc40_batchsize32_cutoff1600_labelsmoothing0.05_lr0.001_gradclip5_factor0.5_patience3/train/best_model.mdl
...
data_config=conf/data/${dataset_name}/${data_name}/asr_tts/data_mfcc40.yaml
