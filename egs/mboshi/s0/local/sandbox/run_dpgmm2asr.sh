...
if [ $stage -le 5 ]; then
    ...
    echo "token2id: '/project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/mboshi/s0/data/lang_1char/train_mb_units.txt'" >> $root/conf/data_dpgmm_seed${seed}_K${K0}.yaml
fi
