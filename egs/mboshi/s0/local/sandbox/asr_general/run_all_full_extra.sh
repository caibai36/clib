...
# only implemented for cat_hybrid_bnf_asr
...
tag=asr_general
dataset_name=mboshi # wsj
data_name=default # wsj0 
feat_name=MFCC39 # MFCC40

train_data=$PWD/data/train_mb # /project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/wsj/s0/data/train_si84
dev_data=$PWD/data/dev_mb # /project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/wsj/s0/data/test_dev93
test_data=$PWD/data/test_mb # /project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/wsj/s0/data/test_eval92
train_set=train_mb # train_si284; name of the training data set
...
if $cat_hybrid_bnf_asr; then
    root1=exp/concatfeat2asr/asr_mboshi_concat_MFCC39_HybridMSEseed123nseed2028K98l8r8_bs256_hd512_nl5_ne20
    ...
    ln -s /project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/mboshi/bnf42/param_bnf/ param_bnf # a feature stored as param_bnf/raw_bnfeat_train_si284.1.ark
    train2=/project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/mboshi/bnf42/data_bnf/train_bnf/feats.scp
    dev2=/project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/mboshi/bnf42/data_bnf/dev_bnf/feats.scp
    test2=/project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/mboshi/bnf42/data_bnf/test_bnf/feats.scp
