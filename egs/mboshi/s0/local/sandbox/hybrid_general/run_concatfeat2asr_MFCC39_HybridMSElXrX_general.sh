...
feat_train2=/project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/mboshi/s0/exp/hybrid2asr_mse/asr_hybrid_mse_seed${seed}nseed${nseed}_K${K0}_l${num_left_context}r${num_right_context}_bs${hybrid_batch_size}_hd${hybrid_hidden_dim}_nl${hybrid_num_layers}_ne${hybrid_num_epochs}/data/train/feats.scp
feat_dev2=/project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/mboshi/s0/exp/hybrid2asr_mse/asr_hybrid_mse_seed${seed}nseed${nseed}_K${K0}_l${num_left_context}r${num_right_context}_bs${hybrid_batch_size}_hd${hybrid_hidden_dim}_nl${hybrid_num_layers}_ne${hybrid_num_epochs}/data/dev/feats.scp
feat_test2=/project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/mboshi/s0/exp/hybrid2asr_mse/asr_hybrid_mse_seed${seed}nseed${nseed}_K${K0}_l${num_left_context}r${num_right_context}_bs${hybrid_batch_size}_hd${hybrid_hidden_dim}_nl${hybrid_num_layers}_ne${hybrid_num_epochs}/data/test/feats.scp
