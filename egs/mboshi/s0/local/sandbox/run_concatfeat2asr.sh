...
dpgmm_data_dir=exp/dpgmm2asr/asr_dpgmm_seed${seed}_K${K0}/data
...
if [ $stage -le 1 ]; then
    ...
    rm -rf $data_dir
    mkdir -p $data_dir
    cp -r data/train_mb $data_dir/train
    cp -r data/dev_mb $data_dir/dev
    cp -r data/test_mb $data_dir/test
