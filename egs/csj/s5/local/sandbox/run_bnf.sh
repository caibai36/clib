...
train_data_dir=data/train_nodev
dev_data_dir=data/train_dev
test_data_dir=data/eval1
align_dir=exp/tri4_ali_nodup
dev_align_dir=exp/tri4/decode_train_dev_csj
test_align_dir=exp/tri4/decode_eval1_csj
model_dir=exp/tri4
...
if [ $stage -le 1 ]; then
	...
	steps/nnet2/train_tanh_bottleneck.sh \
	    ...
	    --num-hidden-layers 5 \
	    --bottleneck-dim 44 --hidden-layer-dim 1024 --cmd "$run_cmd" \
