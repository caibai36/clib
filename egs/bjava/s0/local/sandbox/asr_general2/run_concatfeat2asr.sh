...
#
# Note do not run two bnf asrs at the same time in different shells, they can read only one param_bnf softlink at a moment.
...
feat1_name=MFCC40
feat2_name=BNF42 # kaldi default

feat_train=data/train_si284/feats.scp
feat_dev=data/test_dev93/feats.scp
feat_test=data/test_eval92/feats.scp

feat_train2=/project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/wsj/bnf42/data_bnf/train_bnf/feats.scp
feat_dev2=/project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/wsj/bnf42/data_bnf/dev93_bnf/feats.scp
feat_test2=/project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/wsj/bnf42/data_bnf/eval92_bnf/feats.scp
...
root=exp/concatfeat2asr/asr_${data_name}_${tag}_aseed${asrseed}_concat_${feat1_name}_${feat2_name}
feat=${data_name}_${tag}_aseed${asrseed}_concat_${feat1_name}_${feat2_name}
