...
bnf_feat=true # whether the feature is bottleneck feature
...
root=exp/${dir}/asr_${data_name}_${tag}_aseed${asrseed}_single_${feat_name}
feat=${data_name}_${tag}_aseed${asrseed}_single_${feat_name}
