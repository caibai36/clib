...
feat1_name=MFCC39
feat2_name=HybridMSEseed${seed}nseed${nseed}K${K0}l${num_left_context}r${num_right_context}_bs${hybrid_batch_size}_hd${hybrid_hidden_dim}_nl${hybrid_num_layers}_ne${hybrid_num_epochs}

feat_train=data/train/feats.scp
feat_dev=data/dev/feats.scp
...
# ln -s /project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/timit/s0/param_bnf/ param_bnf # a feature stored as param_bnf/raw_bnfeat_train_si284.1.ark
feat_train2=/project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/timit/zr0/exp/hybrid2asr_mse/asr_hybrid_mse_seed${seed}nseed${nseed}_K${K0}_l${num_left_context}r${num_right_context}_bs${hybrid_batch_size}_hd${hybrid_hidden_dim}_nl${hybrid_num_layers}_ne${hybrid_num_epochs}/data/train/feats.scp
feat_dev2=/project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/timit/zr0/exp/hybrid2asr_mse/asr_hybrid_mse_seed${seed}nseed${nseed}_K${K0}_l${num_left_context}r${num_right_context}_bs${hybrid_batch_size}_hd${hybrid_hidden_dim}_nl${hybrid_num_layers}_ne${hybrid_num_epochs}/data/dev/feats.scp
feat_test2=/project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/timit/zr0/exp/hybrid2asr_mse/asr_hybrid_mse_seed${seed}nseed${nseed}_K${K0}_l${num_left_context}r${num_right_context}_bs${hybrid_batch_size}_hd${hybrid_hidden_dim}_nl${hybrid_num_layers}_ne${hybrid_num_epochs}/data/test/feats.scp

feat=concat_${feat1_name}_${feat2_name}
root=exp/concatfeat2asr/asr_timit_${feat}
...
if [ $stage -le 1 ]; then
    ...
    rm -rf $data_dir
    mkdir -p $data_dir
    cp -r data/train $root/data/train
    cp -r data/dev $root/data/dev
    cp -r data/test $root/data/test
...
if [ $stage -le 5 ]; then
    ...
    echo "token2id: '/project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/timit/zr0/data/lang_1char/train_units.txt'" >> $root/conf/data_${feat}.yaml
fi
