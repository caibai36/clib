...
# add function of cat_hybrid_bnf_asr
...
if $cat_hybrid_bnf_asr; then
    root1=exp/concatfeat2asr/asr_default_asr_general_concat_MFCC39_hybrid_mse_nseed123_l8r8_bs256_hd512_nl5_ne20_from_dpgmm_seed123_K98_with_MFCC39
    ...
    ln -s /project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/timit/bnf42/param_bnf/ param_bnf # a feature stored as param_bnf/raw_bnfeat_train_si284.1.ark
    train2=/project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/timit/bnf42/data_bnf/train_bnf/feats.scp
    dev2=/project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/timit/bnf42/data_bnf/dev_bnf/feats.scp
    test2=/project/nakamura-lab08/Work/bin-wu/workspace/projects/clib/egs/timit/bnf42/data_bnf/test_bnf/feats.scp
