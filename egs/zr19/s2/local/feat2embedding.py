...
import sys
clib_path="../../wsj/s0"
sys.path.append(clib_path)
import clib.kaldi.kaldi_io

feat_scp_file = "data/test_en/feats.scp"
repr_dir = "eval/abx/post/exp/dpgmm/mfcc39"
...
_, first_feat = next(iter(clib.kaldi.kaldi_io.read_mat_scp(args.feat)))
...
for uttid, feat in clib.kaldi.kaldi_io.read_mat_scp(args.feat):
